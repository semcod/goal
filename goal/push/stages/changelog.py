...
def handle_changelog(
    new_version: str, files: list, commit_msg: str, config: dict, no_changelog: bool
) -> None:
    """Update changelog."""
    if not no_changelog:
        ...
        click.echo(click.style("✓ Updated CHANGELOG.md", fg="green"))


def update_changelog_stage(
    new_version: str, files: list, commit_msg: str, config: dict
) -> None:
