...
class CommitBodyFormatter:
    ...
    def _append_entity_change(self, change_lines: List[str], label: str, entities: List[Dict]) -> None:
    ...
    def format_changes_section(self, files: List[str], file_analyses: List[Dict]) -> tuple:
    ...
    def format_body(self, capabilities: List[Dict],
                    roles: List[Dict],
                    relations: Dict,
                    metrics: Dict,
                    files: List[str],
        ...
        changes_section, test_scenarios, has_changes = self.format_changes_section(files, file_analyses)
        if has_changes:
