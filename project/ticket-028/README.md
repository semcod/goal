...
- [ ] AC-02: Goal selects `normal-bump -> 2.1.294` once, synchronizes all five
  release carriers, and subsequently selects `already-bumped`.
- [ ] AC-03: Full tests, build, governance, Docker, target CI and exact-head
...
- [ ] AC-05: A fresh no-cache public-index environment reports Goal 2.1.294.
